...
[连接与重复](codes/5.数据类型/5.str.py ':include :type=code :fragment=lc')
...
[访问与切片](codes/5.数据类型/5.str.py ':include :type=code :fragment=qp')
...
[查找与替换](codes/5.数据类型/5.str.py ':include :type=code :fragment=ct')
...
[分割与合并](codes/5.数据类型/5.str.py ':include :type=code :fragment=fh')
...
[大小写转换](codes/5.数据类型/5.str.py ':include :type=code :fragment=dx')
...
[去除空白](codes/5.数据类型/5.str.py ':include :type=code :fragment=qc')
...
[字符串格式化](codes/5.数据类型/5.str.py ':include :type=code :fragment=gs')
